...
def Resolve_image(image,path):
    ...
    path2=r'C:\Users\marti\OneDrive\Ambiente de Trabalho\Projeto integrador\green.png'
...
path=r'C:\Users\marti\OneDrive\Ambiente de Trabalho\Projeto integrador\imagens\4.jpeg'
image = cv2.imread(path)
h, w, c = image.shape
print('width:  ', w)
print('height: ', h)
#image1 = image.resize((400, 400))
#cv2.imshow("primeira imagem blur", image1) 


blur=Resolve_image(image,path)
